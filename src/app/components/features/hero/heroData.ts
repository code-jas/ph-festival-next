...
export const heroData: HeroData = {
    header: {
        ...
        description: "Festivals are part of our culture in the Philippines where each city or province has a local fiesta. Festivals are the way to promote different province's patron saint or most known product and understand it. It helps us to keep connection with our culture and origin, and to preserve it.",
    ...
    features: [
        ...
        },
        {
            ...
            title: "Discover",
            description: "Discover different and unique culture of different festivals in the Philippines",
        },
    ],
};
