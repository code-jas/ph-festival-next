...
const CarouselPage: React.FC = () => {
     ...
     */
    const getCardClass = useCallback((target: string, index: number) => {
    ...
    useEffect(() => waitForImages(), [waitForImages]);
     ...
     */
    const changeInfo = useCallback((direction: string) => {
        const currentInfoEl = refs.cardInfosContainer.current?.querySelector('.current--info') as HTMLElement;
     ...
     */
    const swapCards = useCallback((direction: string) => {
