...
const FestivalDetailsClient: React.FC<FestivalDetailsClientProps> = ({ festival }) => {
   ...
   return (
      <div className="fest-container">
         {/* back to festival gallery action */}
         ...
         <h1
            ...
            style={{ backgroundImage: `url(${festival.img})`, backgroundPosition: '50% 50%' }}
         >
            {festival.title}
         </h1>
         ...
         <div className="fest-parag-cont">
            ...
            <div className="container">
               {Array.from({ length: 4 }, (_, index) => (
                  <ImageActivites
                     key={index}
                     imageUrl={festival[`imgItem${index + 1}` as keyof FestivalDetailsType]}
                  />
               ))}
            </div>
            {/* Video */}
